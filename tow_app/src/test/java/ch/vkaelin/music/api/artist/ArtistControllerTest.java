...
class ArtistControllerTest {
    ...
    public void setup() {
        ...
        UserEntity user = new UserEntity("bob_user", "1234", Role.ARTIST, null);

        artistRepository.save(new ArtistEntity("Bob", user, null));
    }
    ...
    void shouldGetArtists() throws Exception {
        MvcResult result = mvc
            .perform(get("/api/v1/artists"))
            .andExpect(status().isOk())
            .andExpect(content().contentType("application/json"))
            .andReturn();

        String responseBody = result.getResponse().getContentAsString();
        List<SearchedArtistDto> artists = mapper
            .readerForListOf(SearchedArtistDto.class)
    ...
    void shouldDeleteArtist() throws Exception {
        ...
        mvc
            .perform(delete("/api/v1/artists/" + artistId))
            .andExpect(status().isOk())
            .andReturn();
