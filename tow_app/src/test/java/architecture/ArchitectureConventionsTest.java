...
class ArchitectureConventionsTest {
    ...
    @ArchTest
    static final ArchRule domainShouldHaveStandardDependencies = classes()
        .that()
    ...
    @ArchTest
    static final ArchRule apiShouldNotDependOnPersistence = noClasses()
        .that()
    ...
    static final ArchRule onlyPersistenceShouldAccessSpringDataHibernateAndJpa =
        noClasses()
            ...
            .because(
                "Only persistence should access persistence related third party libraries"
            );
}
