...
var _JSOX__namespace = /*#__PURE__*/_interopNamespaceDefault(_JSOX);
...
const JSOX = _JSOX__namespace.JSOX || _JSOX__namespace;
      ...
      print(path, _a) {
        ...
        if (typeof value === "string") {
          const sqlFormatterOptions = __spreadProps(__spreadValues({}, options), {
            params: params == null ? void 0 : JSOX.parse(params),
            paramTypes: paramTypes == null ? void 0 : JSOX.parse(
              paramTypes
            )
          });
